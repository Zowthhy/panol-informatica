...
Route::get('/dashboard', [computadorasController::class, 'index'])
...
Route::resource('computadoras', computadorasController::class)->middleware('auth');;
...
Route::get('/buscar-computadoras', [computadorasController::class, 'buscar'])->name('buscar.computadoras')->middleware('auth');;
